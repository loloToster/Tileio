    ...
    <DefaultLayout>
      ...
      <section className={styles.landingMobile}>
        <div className={styles.landingMobile__imgWrapper}>
          <Image
            src="/home/landing-mobile-page.png"
            width={500}
            height={600}
            className={styles.landingMobile__img}
            alt="Example Grid"
          />
        </div>
        ...
        <Image
          src="/home/wave.png"
          className={styles.landingMobile__wave}
          width={600}
          height={30}
          alt="wave"
        />
        ...
        <div className={styles.advantages}>
          ...
          <div className={styles.advantages__advantage}>
            <div className={styles.advantages__text}>
              ...
              In the Tileio app you can customize almost everything like colors,
              sizes, urls etc. And even{" "}
              <Link href="/api-docs">create your own cells</Link>!
            </div>
            <Image
              src="/home/highly-customizable.png"
              width={496}
              height={496}
              className={styles.advantages__img}
          ...
          <div className={styles.advantages__advantage}>
            <Image
              src="/home/developer-friendly.png"
              width={496}
              height={496}
              className={styles.advantages__img}
            ...
            <div className={styles.advantages__text}>
              ...
              With the help of our <Link href="/api-docs">APIs</Link> you can
              easily create your dream cell. Dynamic cells are loaded in iframes
              so you only need to know HTML, CSS &amp; JS to begin.
            </div>
          </div>
        </div>
      </section>
